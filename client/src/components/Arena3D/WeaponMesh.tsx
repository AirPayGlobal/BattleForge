function WeaponMesh({
  ...
  // Most weapons only on the right hand; daggers appear on both
  if (side === "left" && type !== "daggers") return null;
  ...
  switch (type) {
    ...
    case "daggers":
      return (
        <group rotation={[0, 0, side === "left" ? 0.5 : -0.5]}>
    ...
    case "staff":
      return (
        <group>
          ...
          <pointLight position={[0, 1.85, 0]} color={accentColor} intensity={1.5} distance={3} />
        </group>
      );
